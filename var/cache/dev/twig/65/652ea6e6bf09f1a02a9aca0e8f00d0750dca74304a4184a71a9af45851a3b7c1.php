...
class __TwigTemplate_39b5da37008d74f3912f4ed7fb7afef622385c5b5a2410a68023bcdb745bd320 extends Twig_Template
{
    private $source;
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new Twig_Error_Runtime('Variable "category" does not exist.', 16, $this->source); })()), "name", array()), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        // line 29
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("category_edit", array("id" => twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new Twig_Error_Runtime('Variable "category" does not exist.', 29, $this->source); })()), "id", array()))), "html", null, true);
        echo "\">edit</a>
...
";
    ...
    {
        return array (  105 => 31,  100 => 29,  94 => 27,  87 => 16,  80 => 12,  72 => 6,  63 => 5,  45 => 3,  15 => 1,);
    }
...
{% block body %}
    ...
    {# 
    {% for user_groups in category.userGroups %}
        {% for user in user_groups.customer %}
            {{user.getName()}}
        {% endfor %}
    {% endfor %}
    #}
...
{% endblock %}
", "category/show.html.twig", "/Users/dileepkumar/Documents/m/my-project/templates/category/show.html.twig");
    }
}
