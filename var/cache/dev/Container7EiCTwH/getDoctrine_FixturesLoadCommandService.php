...
$a->addFixtures(array(0 => array('fixture' => new \App\DataFixtures\AdminFixtures(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php'))), 'groups' => array())));
