...
// Returns the private 'App\Repository\CustomerGroupRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CustomerGroupRepository.php';

return $this->privates['App\Repository\CustomerGroupRepository'] = new \App\Repository\CustomerGroupRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
