...
}, 1), ($this->privates['security.user.provider.concrete.our_db_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_OurDbProviderService.php')), 'main', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())));
